...
2. Use the POV, tense, and scene focus specified by the outline and voice document.
3. Hit ALL numbered beats from the outline in order.
4. Plant ALL foreshadowing elements listed under "Plants."
5. Show sensory detail through the POV character's body and situation.
6. Make speculative costs and constraints concrete when they appear.
...
11. Metaphors must come from the POV character's lived experience and the world bible.
...
24. DIALOGUE should sound like speech, not prose. Characters should
    ...
    slightly wrong. Young characters should not speak in polished epigrams.
