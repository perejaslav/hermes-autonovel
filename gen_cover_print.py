...
def compose_cover(
    ...
    try:
        ...
        raise SystemExit("ERROR: Pillow is required for print cover generation. Install with: uv add pillow") from exc

    title = title or os.environ.get("AUTONOVEL_TITLE", "Untitled Novel")
    author = author or os.environ.get("AUTONOVEL_AUTHOR", "Author")
